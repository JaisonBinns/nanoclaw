...
/**
 * Dependencies required by the IPC system.
 * Injected to prevent tight coupling with main orchestrator.
 */
export interface IpcDeps {
  registeredGroups: () => Record<string, RegisteredGroup>;
  sendMessage: (chatId: string, text: string) => Promise<void>;
  syncChannelMetadata: (force: boolean) => Promise<void>;
  ...
  switch (data.type) {
    ...
    case 'refresh_groups':
      ...
      if (isMain) {
        ...
        await deps.syncChannelMetadata(true);
